...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("• Bullet 1\n- Bullet 2\n* Bullet 3\n- Bullet 4", 4),  # Multiple bullet formats
        ("• Bullet 1\n• Bullet 2\n• Bullet 3 with numbers 123", 0),  # Bullets with alphanumeric characters
        ("• Bullet 1\n• Bullet 2\n• Bullet 3 with special characters @#$", 0),  # Bullets with special characters
        ("This is a regular line.\n• Bullet 1\nThis is another regular line.\n- Bullet 2\nThis is a third regular line.", 2),  # Mixed bullet and non-bullet lines
        ("• Bullet 1\n• Bullet 1\n• Bullet 2\n• Bullet 2\n• Bullet 2", 3),  # Duplicate bullets
        ("• Bullet 1\n- Bullet 2\n* Bullet 3", 3),  # Different bullet characters
        (" • Bullet 1\n• Bullet 2 \n • Bullet 3 ", 3),  # Leading and trailing spaces in bullet lines
